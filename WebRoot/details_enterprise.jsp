...
<body class="back">
	...
	<%
		...
		HouseSellEnterprise house = (HouseSellEnterprise) session
				.getAttribute("house");
		EnterpriseUsers home = (EnterpriseUsers) session
				.getAttribute("home");
		double p = house.getLangArea();
		int sz = (int) p;
		String s1[];
	...
	<div class="container-fluid mt back">
			...
			<div class="span12">
				<div class="row-fluid back">
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="row-fluid">
									...
									<div class="span6">
										<div class="line1">
											房价 &nbsp;<span class="prise">￥<em>${ house.getPrice()}元/㎡</em></span>

										</div>
										<div class="line3">
											<strong>主要户型:</strong>${ house.getMainType()}&nbsp;&nbsp;&nbsp;
											<strong>建筑面积:</strong>${ house.getSize()}㎡&nbsp;&nbsp;&nbsp;
										</div>
										<div class="line3">
											<strong>规划户数:</strong> ${house.getPlanningNum() }户&nbsp;&nbsp;&nbsp;
											<strong>已售户数:</strong> ${house.getSelledNum() }户
										</div>
										<div class="line3">
											<strong>占地面积：</strong><%=sz%>㎡
										</div>
										<div class="line3">
											<strong>开发商:</strong>${ house.getDeveloperName()}
										</div>
										<div>
					...
					<div class="col-xs-6 span3 ml">
						...
						<div>
							<p>
								企业地址:<span class="gray">${home.getUAddr() } </span>
							</p>
							<p class="line3">
						...
						<div style="margin-top:30px">
							<p>
								<%
									String s = "黄刘胤房产网认证<span class=\"prise\">100% </span>真房源<br />";
						...
						<div class="tab-pane active" id="panel-239168">
							...
							<form action="HouseAction!addcomment" method="post"
								...
								<input type="text" name="comment.comment" id="shuru" /> <input
									...
									value=${house.getHId() } />
								<input type="hidden" name="comment.CType" id="CType" value="1" />
								<input type="hidden" name="comment.users.UId" id="UId"
		...
		<div class="row-fluid mt">
			...
			<div class="bdup" style="margin-left:40px">
				<div class="line3">
					<p>
						楼盘名称:&nbsp;&nbsp;${house.getBuildingName()}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						停车位:&nbsp;&nbsp;${house.getParkingNum() }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						绿化率:&nbsp;&nbsp;${house.getGreeningRate()*100 }%</p>
				</div>
				<div class="line3">开盘时间:&nbsp;&nbsp;${house.getOpeningDate() }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					入住时间:&nbsp;&nbsp;${house.getFinishDate() }</div>
				<div class="line3">
					物业公司:&nbsp;&nbsp;${house.getPropertyName()}</div>
