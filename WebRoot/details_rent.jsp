...
<body class="back">
	...
	<%
		...
		HouseSellRent house = (HouseSellRent) session.getAttribute("house");
				...
				<div class="row-fluid back">
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="row-fluid">
									...
									<div class="span6">
										<div class="line1">
											月租 &nbsp;<span class="prise">￥<em>${ house.getPrice()}元</em></span>
					...
					<div class="col-xs-6 span3 ml">
						...
						<div style="margin-top:30px">
							<p>
								<%
									s = "不可描述房产网认证<span class=\"prise\">100% </span>真房源<br />";
					...
					<div class="tab-content">
						<div class="tab-pane active" id="panel-239168">
							...
							<form action="HouseAction!addcomment" method="post"
								style="float:right; margin-right:15%;" onsubmit="return time()">
								<input type="text" name="comment.comment" id="shuru" /> <input
									...
									value=${house.getHId() } /> <input type="hidden"
									name="comment.CType" id="CType" value="3" /> <input
