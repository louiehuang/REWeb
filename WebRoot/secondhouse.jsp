		...
		<div style="width:100% height:auto;">
			<div style="float:left;">
				<img src="images/houselist/logo.png"> <a><font size="4"
					face="微软雅黑" color="red">二手房</font></a> <a
			...
			<div class="box">
				...
				<ul class="list">
					...
					<li style="margin-top:10px;"><span><img
							src="images/houselist/look.png" align="middle">报名看房，免费车接送</span></li>
				</ul>
				<div>
					<div align="right">
						<span><font size="8" color="89d6bc"><b>150</b></font></span><font
							color="gray">万</font>
					</div>
					<div align="right">
						<span style="font-size: 15px;font-family:'微软雅黑';margin-top:60px;">首付：<span
							style="font-size: 15px;font-family:'微软雅黑';">103</span>万元起
						</span></span> &nbsp;<span style="font-size: 15px;font-family:'微软雅黑';">月供：<span
							style="font-size: 15px;font-family:'微软雅黑';">13993</span>元起
						</span></span>
					</div>
					<div align="right">
