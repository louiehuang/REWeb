...
<title>AdminPanel</title>
    ...
    <script type="text/javascript">window.jQuery || document.write('<script type="text/javascript" src="js/admin/jquery-1.7.2.min.js"><\/script>');</script>
    ...
    <div id="wrapper">
				...
				<div class="tabs">
					<div id="tab-1" class="tab">
						...
						<div class="my-center-block">
						  <button name="verify_save" class="btn btn-info " onclick="">保存</button><!--保存  post修改值至后台-->
					   </div>
					</div>
					...
					<div id="tab-2" class="tab">
						<article>
						  ...
						  <div class="my-center-block">
						    <button name="complain_save" class="btn btn-info" onclick="">保存</button><!--保存  post修改值至后台-->
					     </div>
						</article>
					</div>
						...
						<article>
						   <div class="text-section">
							...
							<ul class="nav nav-tabs">
					           <li class="active">
						         <a href="#addUser" data-toggle="tab">添加/修改</a>
					           </li>
					           <li>
						         <a href="#delUser" data-toggle="tab">查看/删除</a>
					           </li>
				            </ul>
				            <div class="tab-content">
					           <div class="tab-pane active" id="addUser">
					           	<div class="container-fluid">
		                            ...
		                            <div class="container">
		                            	<div class="my-query">
		                               	   <input style="width:200px;height:30px;" type="text" placeholder="请输入用户ID..." /> 
			                               <button type="submit" class="btn btn-primary" onclick="changeToUserUpdate()">查询</button>
			                               <button type="submit" class="btn btn-primary" onclick="changeToUserAdd()">退出修改</button>
		                               </div>
		                                <div class="accordion" id="accordion-423793">
				                         <div class="accordion-group accordion-group-gap">
					                        <div class="accordion-heading ">
						                       <a class="accordion-toggle my-accordion" data-toggle="collapse" data-parent="#accordion-423793" href="#accordion-element-basic">基本信息</a>
					                        </div>
                                     ...
                                     <div class="my-container">
                                      ...
                                      <label class="my-control-label">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</label>
                                        <div class="swicth my-control" >
                                          <input type="radio" name="sex" id="inputSex"/>
                                        </div>
                                     </div>
                                    </div>
					               </div>
				                 ...
				                 <div class="accordion-group accordion-group-gap">
					                <div class="accordion-heading">
						               <a class="accordion-toggle my-accordion" data-toggle="collapse" data-parent="#accordion-423793" href="#accordion-element-detail">详细信息</a>
					                </div>
					                <div id="accordion-element-detail" class="accordion-body in">
						                <div class="accordion-inner accordion-gap ">
							                <div class="my-container">
                                      <label class="my-control-label">联系电话</label>
                                         <div class=" my-control">
                                         <input id="inputPhoneNumber" type="text" size="13" maxlength="13" onKeyUp="checkNum(this);" />
                                       </div>
                                     </div>
                                      <div class="my-container">
					                 ...
					                 <div class="my-container">
                                       <label class="my-control-label">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址</label>
					                       <div class="my-control" >
						                            <select class="select my-select" id="province-select"> 
                                                       <option></option>
                                                     </select>
                                                     <select class="select my-select" id="city-select"> 
                                                       <option></option>
                                                     </select>
                                                     <select class="select my-select" id="county-select"> 
                                                       <option></option>
                                                     </select>
                                                     <br/>
                                          <input class="input-large margin-top" type="text" id="inputCommunity"/> 
                                          <br/>
					                    </div>
					                  </div>
				                   </div>
				                 ...
				                 <div class="accordion-group accordion-group-gap">
				                 	<br/>
					                 <div class="accordion-heading">
						                <a class="accordion-toggle my-accordion" data-toggle="collapse" data-parent="#accordion-423793" href="#accordion-element-power">权限信息</a>
					                 </div>
					                 <div id="accordion-element-power" class="accordion-body in">
						                <div class="accordion-inner accordion-gap ">
							                <div class="my-container">
                                               <label class="my-control-label">信用等级</label>
                                                 <select class="selectpicker my-control my-select" id="credit-select">
                                         	       <option>五星</option>
                                         	       <option>四星</option>
                                               	   <option>三星</option>
                                         	       <option>二星</option>
	                         ...
	                         <br/>
	                         <div class="my-center-block">
                                <input type="button" class="btn btn-large btn-primary " value="提交" id="add_user_submit" >
					         </div>  
					     </div>
					    </div>
					    <br/><br/>
                                   ...
                                   <div class="tab-pane" id="delUser">
						             ...
						             <button class="btn btn-info my-center-block accordion-gap" name="del_user_submit">确认删除</button>
					                 </div>
						         </div>
						        </div>
					          </article>
					...
					<div id="tab-4" class="tab">
						<article>
					       <div class="text-section">
							...
							<ul class="nav nav-tabs">
					           <li>
						         <a href="#updateHouse" data-toggle="tab">更改房屋信息</a>
					           </li>
					           <li>
						         <a href="#delHouse" data-toggle="tab">删除房屋信息</a>
					           </li>
				            </ul>
				            <div class="tab-content">
						          ...
						          <div class=" accordion-gap">
                                         <div class="container-fluid">
	                                        <div class="row-fluid">
		                                       <div class="container">
		                                       	<div class="my-container">
			          	                          <input class="input-medium search-query my-input" type="text" placeholder="请输入房源信息ID..."/>
                                    ...
                                    <div class="my-container">
					                 ...
					                 <div class="my-container">
                                      ...
                                      <label class="my-control-label">有&nbsp;&nbsp;&nbsp;&nbsp;效&nbsp;&nbsp;&nbsp;&nbsp;性</label>
                                         <div class="bootstrap-switch my-control">
                                           <input type="radio" name="availability" id="inputAvailability"/>
                                         </div>
                                      </div>
					                 <div class="my-center-block">
						               <button class="btn btn-info accordion-gap" name="update_house_submit">保存修改</button>
			                        </div>
					              </div>  
	                           </div>
                             </div>
						 ...
						 <div class="tab-pane" id="delHouse">
						     <div class="container accordion-gap">
                                <table class="table table-hover " id="HouseTables">
						          ...
						          <div class="my-center-block">
						            <button class="btn btn-info accordion-gap" name="del_house_submit">确认删除</button>
					              </div>
					            </div>
						     </div>
				          </div>
					...
					<article>
						...
						<ul class="nav nav-tabs">
					      <li class="active">
						     <a href="#addAd" data-toggle="tab">添加/修改</a>
					      </li>
					      <li>
						     <a href="#delAd" data-toggle="tab">查看/删除</a>
					       </li>
				        </ul>
				        <div class="tab-content">
					       <div class="tab-pane active" id="addAd">
					          <div class="container-fluid">
		                            ...
		                            <div class="container">
		                            	<div class="my-query">
		                               	   <input style="width:200px;height:30px;" type="text" placeholder="请输入广告ID..." /> 
			                               <button type="submit" class="btn btn-primary" onclick="changeToAdUpdate()">查询</button>
			                               <button type="submit" class="btn btn-primary" onclick="changeToAdAdd()">退出修改</button>
		                               </div>
		                               <div class="my-container accordion-gap">
                                     ...
                                     <label class="my-control-label">内&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;容</label>
                                         <div class=" my-control">
                                         <textarea id="inputAdContent" type="text" style="width:300px;height:80px;"></textarea>
                                       </div>
                                   </div>
                                </div>
	                         </div>
	                         <br/>
	                         <div class="my-center-block">
                                <input type="button" class="btn btn-large btn-primary " value="提交" id="add_ad_submit" name="bt">
					         </div>  
					     </div>
					    </div>
					   <div class="tab-pane" id="delAd">
						  <div class="container accordion-gap">
                              <table class="table table-hover " id="AdTable">
						          ...
						          <div class="my-center-block">
						            <button class="btn btn-info accordion-gap" name="del_ad_submit">确认删除</button>
					              </div>
					           </div>
						   </div>
					</article>
		...
		<aside id="sidebar">
			...
			<ul class="tabset buttons">
				<li class="active">
					<a href="#tab-1" class="ico1"><span>申请列表</span><em></em></a>
					<span class="tooltip"><span>申请列表</span></span>
				</li>
				
				<li>
					<a href="#tab-2" class="ico3"><span>投诉列表</span><em></em></a>
					<span class="tooltip"><span>投诉列表</span></span>
				</li>
				<li>
					<a href="#tab-3" class="ico2"><span>用户信息管理</span><em></em></a>
					<span class="tooltip"><span>用户信息管理</span></span>
				</li>
				
				<li>
					<a href="#tab-4" class="ico4" ><span>房屋信息管理</span><em></em></a>
					<span class="tooltip"><span>房屋信息管理</span></span>
				</li>
				<li>
					<a href="#tab-5" class="ico5" ><span>发布广告</span><em></em></a>
					<span class="tooltip"><span>发布广告</span></span>
				</li>
			</ul>
