...
<%
	...
	<% }%>
  	...
  	<div class="container">
	<form action="rentHouseAct" > 
		<div style="width:100% height:auto;float:left;">
			<img style="float:left;"src="images/houselist/logo.png"> <a style="float:left;"><font size="4" face="微软雅黑" color="red">租房</font></a>
		...
		<div align="left" class="container">
			<span><font size="4" color="black"><b>月租：</b></font></span> 
			    <a href="rentHouseAct?price=0" style="font-size:14px;font-family: '微软雅黑';color:dodgerblue;">不限</a>&nbsp;&nbsp; 
				<a href="rentHouseAct?price=1" style="font-size:14px;font-family: '微软雅黑';color:black;">1000元以下</a>&nbsp;&nbsp;  
				<a href="rentHouseAct?price=2" style="font-size:14px;font-family: '微软雅黑';color:black;">1000~2000元</a>&nbsp;&nbsp; 
		        <a href="rentHouseAct?price=3" style="font-size:14px;font-family: '微软雅黑';color:black;">2000~3000元</a>&nbsp;&nbsp; 
				<a href="rentHouseAct?price=4" style="font-size:14px;font-family: '微软雅黑';color:black;">3000~4000元</a>&nbsp;&nbsp; 
			    <a href="rentHouseAct?price=5" style="font-size:14px;font-family: '微软雅黑';color:black;">4000~5000元</a>&nbsp;&nbsp;
			    <a href="rentHouseAct?price=6" style="font-size:14px;font-family: '微软雅黑';color:black;">5000元以上</a>&nbsp;&nbsp; 
		</div>
			
			<div align="left" class="container">
				<span><font size="4" color="black"><b> 面积：</b></font></span> 
				 <a href="rentHouseAct?size=0" style="font-size:14px;font-family: '微软雅黑';color:dodgerblue;">不限</a>&nbsp;&nbsp;
				 <a href="rentHouseAct?size=1" style="font-size:14px;font-family: '微软雅黑';color:black;">50㎡</a>&nbsp;&nbsp;
				 <a href="rentHouseAct?size=2" style="font-size:14px;font-family: '微软雅黑';color:black;">50~100㎡</a>&nbsp;&nbsp;
				 <a href="rentHouseAct?size=3" style="font-size:14px;font-family: '微软雅黑';color:black;">100~150㎡</a>&nbsp;&nbsp;
				 <a href="rentHouseAct?size=4" style="font-size:14px;font-family: '微软雅黑';color:black;">150~200㎡</a>&nbsp;&nbsp;
				 <a href="rentHouseAct?size=5" style="font-size:14px;font-family: '微软雅黑';color:black;">200㎡以上</a>&nbsp;&nbsp;
			</div>
			
			<div align="left" class="container">
				<span><font size="4" color="black"><b> 楼层：</b></font></span>
			     <a href="rentHouseAct?floor=0" style="font-size:14px;font-family: '微软雅黑';color:dodgerblue;">不限</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=1" style="font-size:14px;font-family: '微软雅黑';color:black;">一楼</a>&nbsp;&nbsp;  
		         <a href="rentHouseAct?floor=2" style="font-size:14px;font-family: '微软雅黑';color:black;">二楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=3" style="font-size:14px;font-family: '微软雅黑';color:black;">三楼</a>&nbsp;&nbsp; 
			     <a href="rentHouseAct?floor=4" style="font-size:14px;font-family: '微软雅黑';color:black;">四楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=5" style="font-size:14px;font-family: '微软雅黑';color:black;">五楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=6" style="font-size:14px;font-family: '微软雅黑';color:black;">六楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=7" style="font-size:14px;font-family: '微软雅黑';color:black;">七楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=8" style="font-size:14px;font-family: '微软雅黑';color:black;">八楼</a>&nbsp;&nbsp; 
				 <a href="rentHouseAct?floor=9" style="font-size:14px;font-family: '微软雅黑';color:black;">九楼</a>&nbsp;&nbsp; 
			     <a href="rentHouseAct?floor=10" style="font-size:14px;font-family: '微软雅黑';color:black;">十楼</a>&nbsp;&nbsp; 
			</div>
		...
		<div class="my-area">
			...
			<div class="my-sort">
				...
				<a href="rentHouseAct!noLimit" style="font-size:14px;font-family: '微软雅黑';color:black;">默认</a>&nbsp;
				<a href="rentHouseAct!noLimit" style="font-size:14px;font-family: '微软雅黑';color:black;">最新<img src="images/houselist/arrow_down.png" /> </a>&nbsp;
				<a href="rentHouseAct!arrayPrice" style="font-size:14px;font-family: '微软雅黑';color:black;">价格<img	src="images/houselist/arrow_up.png" /> </a>&nbsp;
				<a href="rentHouseAct!arraySize" style="font-size:14px;font-family: '微软雅黑';color:black;">面积<img src="images/houselist/arrow_down.png" /></a>
			</div>
				 <form action="com.chinasoft.action.rentHouseAct">
