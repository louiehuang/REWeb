...
<script type="text/javascript">
	...
	function EnterUserLogin() {
		...
		var span = document.getElementById("AdminUserLoginResSpan");
		...
		if (UAccount == "") {
			...
			$
					.ajax({
						url : 'json_loginAdminUser.action',
						type : 'post',
						dataType : "json",
						data : {
							"administrator.account" : UAccount,
							"administrator.pwd" : UPwd,
						},
						...
						success : function(data) {
							if (data.adminLoginFlag == "1") {
								document
										.getElementById("AdminUserLoginResSpan").innerHTML = "<font color='red'>"
										+ UAccount + "账号或密码错误</font>";
							} else if (data.adminLoginFlag == "0") {
								...
								<div class="registration_form">
									...
									<div>
										<label> <input placeholder="用户名:" type="text"
											id="login_UAccount" name="adminUsers.Uname" tabindex="3"
											required="">
										</label>
									</div>
									<div>
										<label> <input placeholder="密码" type="password"
											id="login_UPwd" name="adminUsers.UPwd" tabindex="4"
											required="">
										</label>
									</div>
									...
									<p>
										<span id="AdminUserLoginResSpan"></span>
									</p>
