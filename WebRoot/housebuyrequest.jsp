...
<body onload="setup();preselect('湖北省');initYear();">
  <div class="container">
 	<form action="rm!postNewBuy" method="post" enctype="multipart/form-data" id="form1" onsubmit="checkSelect()">
		<div class="div1">
					<br />
					<p>
					...
					<br /> 
						...
						<select id="province-select"  style="width: 146px;height:28px;margin-left:28px;" name="houseBuyRequest.region.province"><option>请选择省份</option></select>
						<select id="city-select" style="width: 146px;height:28px;" name="houseBuyRequest.region.city"><option>请选择城市</option></select>
						<select id="county-select" style="width: 146px;height:28px;" name="houseBuyRequest.region.county" ><option>请选择区域</option></select>
						<br />
						<span style="color: red;margin-left:30px;">*</span>期望价格：
				        <input required="" style="width:100px;height: 20px;" type="text" name="houseBuyRequest.pirce"  /><span style="margin-left:10px;">万元</span>
					              <span style="color: red;margin-left:75px;">*</span>期望户型：
				            		<select name="houseBuyRequest.houseType.name" style="width: 136px;height:28px;">
				 		            <option value="1室0厅" >
											1室0厅
										</option> 
										<option value="1室1厅" >
								  ...
								  <select style="width:100px;height:28px;margin-left: 27px;" name="houseBuyRequest.orientation">
									...
									<input required="" style="width: 120px;height: 20px;margin-left:12px;" type="text" name="houseBuyRequest.size" />
					              	<br /> 
									<span style="color:red;margin-left:30px;">*</span>楼层：
									<input required="" style="width: 90px;height: 20px;margin-left:25px;" type="text" name="houseBuyRequest.houseFloor" />
					              	<span style="color:red;margin-left:128px;">*</span>装修情况：
								    <select style="width:114px;height:28px;" name="houseBuyRequest.decoration">
								...
								<div class="div1">
									...
									<p>
									 <span style="color:red;margin-left:30px;">*</span>标题：&nbsp;&nbsp;&nbsp;<input required="" style="width: 500px;height: 20px;margin-left:20px;" type="text" name="houseBuyRequest.title" />
								  </p>
								  <span style="color:red;margin-left:30px;">*</span><span >具体要求：</span><textarea name="houseBuyRequest.remark" style="width: 500px;height: 50px;margin-left：20px;" type="text" required=""></textarea><br /><br /> 
								</div><br />
