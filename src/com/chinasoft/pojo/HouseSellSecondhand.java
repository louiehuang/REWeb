...
/**
 * HouseSellSecondhand entity. @author MyEclipse Persistence Tools
 */

public class HouseSellSecondhand implements java.io.Serializable {
	...
	/** default constructor */
	public HouseSellSecondhand() {
	}

	/** minimal constructor */
	public HouseSellSecondhand(HouseType houseType, Integer UId, Double price,
			Double size) {
