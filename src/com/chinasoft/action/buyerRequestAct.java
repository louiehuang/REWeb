...
import com.chinasoft.service.buyerRequest;

public class buyerRequestAct {
	private HouseBuyRequest hbrq;
	private buyerRequest  rhouse;
...
//set   get
	...
	public HouseBuyRequest getHsr() {
		return hbrq;
	}
	public void setHsr(HouseBuyRequest hbrq) {
		this.hbrq = hbrq;
	}
	public buyerRequest getRhouse() {
		return rhouse;
	}
	public void setRhouse(buyerRequest rhouse) {
		this.rhouse = rhouse;
	}
	...
	public String noLimit() throws Exception{
		...
		public String arraySize()throws Exception{
			try {
				sth.setLength(0);
				sth.append(rhouse.arraySize(hbrq));
				num = rhouse.getNumber();
				if(num==0){
				    sth.setLength(0);
					sth.append("<div align='center'><img  src='images/findnothing.png'  /></div>");
		...
		public String arrayPrice()throws Exception{
			try {
				sth.setLength(0);
				sth.append(rhouse.arrayPirce(hbrq));
				num = rhouse.getNumber();
				if(num==0){
				    sth.setLength(0);
					sth.append("<div align='center'><img  src='images/findnothing.png'  /></div>");
